...
import { GoalRepository, GoalRepositoryTag, UserRepository, UserRepositoryTag } from '../domain/repositories';
import { CreateGoal, Goal, GoalId, UpdateGoal } from '../domain/goal';
...
export const getGoal = (
  ...
  Effect.gen(function* (_) {
    ...
    if (goal.userId !== userId) {
      return yield* _(Effect.fail(new UnauthorizedError('Not authorized to access this goal')));
    }
...
export const updateGoal = (
  ...
  Effect.gen(function* (_) {
    ...
    if (goal.userId !== userId) {
      return yield* _(Effect.fail(new UnauthorizedError('Not authorized to update this goal')));
    }
...
export const deleteGoal = (
  ...
  Effect.gen(function* (_) {
    ...
    if (goal.userId !== userId) {
      return yield* _(Effect.fail(new UnauthorizedError('Not authorized to delete this goal')));
    }
