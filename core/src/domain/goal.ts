...
export const GoalTitle = S.string.pipe(S.minLength(1), S.maxLength(100), S.brand('GoalTitle'));
export type GoalTitle = S.Schema.To<typeof GoalTitle>;

export const GoalDescription = S.string.pipe(S.maxLength(1000), S.brand('GoalDescription'));
